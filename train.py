    ...
    for epoch in range(1, epochs+1):
        ...
        for i, data in enumerate(dataloader_train, start=1):
            ...
            if i % batches_show == 0:
                ...
                with open(r"loss_record\mobile_v3.txt", "a", encoding="UTF-8") as f:
                    f.write("\n" + summary)
...
if __name__ == '__main__':
    train_and_eval(
        ...
        epochs=13, batches_show=10, save_dir="work_dir_res50.test", save_interval=1,
        lr=0.001,
        keypoint_weight=1.0, mask_weight=1.0,
        load_from=None)

    # model = maskkeypointrcnn_resnet50_fpn(num_classes=2, num_keypoints=2)
    # model.load_state_dict(torch.load(r"E:\UAV_mmdet\MaskKeypointRCNN-pytorch-master\MaskKeypointRCNN-pytorch-master\work_dir_res50.test\epoch_13.state_dict.pth"))
    # test_model(model, "data/tmp_database/final_dataset/img_test",
